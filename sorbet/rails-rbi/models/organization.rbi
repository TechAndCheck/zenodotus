...
module Organization::GeneratedAssociationMethods
  ...
  def build_admin(*args, &block); end

  sig { params(args: T.untyped, block: T.nilable(T.proc.params(object: ::User).void)).returns(::User) }
  def create_admin(*args, &block); end
...
module Organization::QueryMethodsReturningRelation
  ...
  sig { params(block: T.proc.params(e: Organization).returns(T::Boolean)).returns(T::Array[Organization]) }
  def select(&block); end

  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(Organization::ActiveRecord_Relation) }
...
module Organization::QueryMethodsReturningAssociationRelation
  ...
  sig { params(args: T.any(String, Symbol, T::Array[T.any(String, Symbol)])).returns(Organization::ActiveRecord_AssociationRelation) }
  def select_columns(*args); end
