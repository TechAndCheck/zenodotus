...
class ROTP::OTP
  ...
  #
  # source://rotp//lib/rotp/otp.rb#14
  ...
  # source://rotp//lib/rotp/otp.rb#48
  def byte_secret; end
  ...
  #
  # source://rotp//lib/rotp/otp.rb#56
  def int_to_bytestring(int, padding = T.unsafe(nil)); end

  # constant-time compare the strings
  #
  # source://rotp//lib/rotp/otp.rb#70
  def time_constant_compare(a, b); end

  # @raise [ArgumentError]
  #
  # source://rotp//lib/rotp/otp.rb#41
...
class ROTP::OTP::URI
  ...
  # source://rotp//lib/rotp/otp/uri.rb#42
  def label; end

  # source://rotp//lib/rotp/otp/uri.rb#50
  def parameters; end

  # source://rotp//lib/rotp/otp/uri.rb#64
  def period; end

  # source://rotp//lib/rotp/otp/uri.rb#71
  def type; end
