...
module Bullet
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://bullet//lib/bullet.rb#257
    ...
    # source://bullet//lib/bullet.rb#171
    def end_request; end

    # source://bullet//lib/bullet.rb#215
    def footer_info; end

    # source://bullet//lib/bullet.rb#201
    ...
    # source://bullet//lib/bullet.rb#207
    def perform_out_of_channel_notifications(env = T.unsafe(nil)); end

    # source://bullet//lib/bullet.rb#237
    def profile; end
    ...
    # @return [Boolean]
    #
    # source://bullet//lib/bullet.rb#186
    def start?; end
    ...
    # source://bullet//lib/bullet.rb#221
    ...
    # source://bullet//lib/bullet.rb#229
    def warnings; end
    ...
    # source://bullet//lib/bullet.rb#278
    def build_request_uri(env); end

    # source://bullet//lib/bullet.rb#269
...
class Bullet::Detector::NPlusOneQuery < ::Bullet::Detector::Association
  ...
  class << self
    # source://bullet//lib/bullet/detector/n_plus_one_query.rb#57
    def add_impossible_object(object); end

    # source://bullet//lib/bullet/detector/n_plus_one_query.rb#66
    ...
    # @return [Boolean]
    #
    # source://bullet//lib/bullet/detector/n_plus_one_query.rb#92
    ...
    # @return [Boolean]
    #
    # source://bullet//lib/bullet/detector/n_plus_one_query.rb#87
    def impossible?(object); end

    # @return [Boolean]
    #
    # source://bullet//lib/bullet/detector/n_plus_one_query.rb#83
    def possible?(object); end

    private

    # source://bullet//lib/bullet/detector/n_plus_one_query.rb#107
...
module Bullet::StackTraceFilter
  ...
  #
  # source://bullet//lib/bullet/stack_trace_filter.rb#13
  def caller_in_project(bullet_key = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://bullet//lib/bullet/stack_trace_filter.rb#25
  def excluded_stacktrace_path?; end

  private

  # source://bullet//lib/bullet/stack_trace_filter.rb#56
  def location_as_path(location); end

  # @return [Boolean]
  #
  # source://bullet//lib/bullet/stack_trace_filter.rb#33
  def pattern_matches?(location, pattern); end

  # source://bullet//lib/bullet/stack_trace_filter.rb#62
  def select_caller_locations(bullet_key = T.unsafe(nil)); end
end

# source://bullet//lib/bullet/stack_trace_filter.rb#10
