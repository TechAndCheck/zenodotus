...
module URI
  ...
  class << self
    ...
    # @raise [ArgumentError]
    #
    # source://uri//uri/common.rb#399
    def _decode_uri_component(regexp, str, enc); end

    # source://uri//uri/common.rb#385
...
class URI::Source < ::URI::File
  # source://tapioca/0.16.1/lib/tapioca/helpers/source_uri.rb#58
  ...
  # source://tapioca/0.16.1/lib/tapioca/helpers/source_uri.rb#25
  ...
  # source://tapioca/0.16.1/lib/tapioca/helpers/source_uri.rb#51
  sig { params(v: T.nilable(::String)).void }
  def set_path(v); end

  # source://tapioca/0.16.1/lib/tapioca/helpers/source_uri.rb#70
  sig { returns(::String) }
  def to_s; end

  class << self
    # source://tapioca/0.16.1/lib/tapioca/helpers/source_uri.rb#38
    sig do
      params(
        gem_name: ::String,
...
# source://uri//uri/common.rb#287
URI::TBLENCURICOMP_ = T.let(T.unsafe(nil), Hash)

module URI::Util
  private

  # source://uri//uri/common.rb#38
