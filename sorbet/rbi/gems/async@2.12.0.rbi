...
class Async::Scheduler < ::Async::Node
  ...
  #
  # source://async//lib/async/scheduler.rb#383
  ...
  # @return [Boolean]
  #
  # source://async//lib/async/scheduler.rb#107
  def closed?; end

  # source://async//lib/async/scheduler.rb#401
  def fiber(*_arg0, **_arg1, &_arg2); end

  # Interrupt the event loop and cause it to exit.
  #
  # source://async//lib/async/scheduler.rb#117
  def interrupt; end

  # source://async//lib/async/scheduler.rb#231
  def io_read(io, buffer, length, offset = T.unsafe(nil)); end

  # source://async//lib/async/scheduler.rb#210
  ...
  # source://async//lib/async/scheduler.rb#182
  def kernel_sleep(duration = T.unsafe(nil)); end

  # Compute the scheduler load according to the busy and idle times that are updated by the run loop.
  #
  # source://async//lib/async/scheduler.rb#47
  def load; end
  ...
  #
  # source://async//lib/async/scheduler.rb#134
  def push(fiber); end
  ...
  #
  # source://async//lib/async/scheduler.rb#345
  def run(*_arg0, **_arg1, &_arg2); end
  ...
  # source://async//lib/async/scheduler.rb#111
  def to_s; end

  # Transfer from the calling fiber to the event loop.
  #
  # source://async//lib/async/scheduler.rb#123
  def transfer; end

  # source://async//lib/async/scheduler.rb#171
  def unblock(blocker, fiber); end

  # Invoke the block, but after the specified timeout, raise {TimeoutError} in any currenly blocking operation. If the block runs to completion before the timeout occurs or there are no non-blocking operations after the timeout expires, the code will complete without any exception.
  #
  # source://async//lib/async/scheduler.rb#407
  ...
  # @return [Boolean]
  #
  # source://async//lib/async/scheduler.rb#331
  def interrupted?; end
  ...
  #
  # source://async//lib/async/scheduler.rb#292
  def run_once!(timeout = T.unsafe(nil)); end
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://async//lib/async/scheduler.rb#27
    def supported?; end
  end
end
...
# source://async//lib/async/task.rb#19
class Async::Stop::Later
  ...
  # @return [Boolean]
  #
  # source://async//lib/async/task.rb#24
  def alive?; end

  # source://async//lib/async/task.rb#28
  def transfer; end
end
...
class Async::Task < ::Async::Node
  ...
  # @return [Boolean]
  #
  # source://async//lib/async/task.rb#149
  def complete?; end
  ...
  # @return [Boolean]
  #
  # source://async//lib/async/task.rb#301
  def current?; end
  ...
  #
  # source://async//lib/async/task.rb#260
  def defer_stop; end

  # @return [Boolean]
  #
  # source://async//lib/async/task.rb#139
  def failed?; end

  # @attr fiber [Fiber] The fiber which is being used for the execution of this task.
  #
  # source://async//lib/async/task.rb#119
  def fiber; end
  ...
  #
  # source://async//lib/async/task.rb#205
  def result; end

  # Begin the execution of the task.
  #
  # source://async//lib/async/task.rb#159
  ...
  #
  # source://async//lib/async/task.rb#104
  ...
  #
  # source://async//lib/async/task.rb#156
  def status; end
  ...
  # @return [Boolean]
  #
  # source://async//lib/async/task.rb#144
  def stopped?; end
  ...
  #
  # source://async//lib/async/task.rb#188
  def wait; end
  ...
  #
  # source://async//lib/async/task.rb#109
  def with_timeout(duration, exception = T.unsafe(nil), message = T.unsafe(nil), &block); end
  ...
  # source://async//lib/async/task.rb#366
  def stop!; end

  # source://async//lib/async/task.rb#346
  def stopped!; end
  ...
  class << self
    ...
    #
    # source://async//lib/async/task.rb#291
    def current; end
    ...
    # @return [Boolean]
    #
    # source://async//lib/async/task.rb#297
    def current?; end
