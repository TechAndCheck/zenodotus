...
# source://test-prof//lib/test_prof/memory_prof/minitest.rb#7
class Minitest::TestProf::MemoryProfReporter < ::Minitest::TestProf::BaseReporter
  # @return [MemoryProfReporter] a new instance of MemoryProfReporter
  #
  # source://test-prof//lib/test_prof/memory_prof/minitest.rb#10
  def initialize(io = T.unsafe(nil), options = T.unsafe(nil)); end

  # Returns the value of attribute current_example.
  #
  # source://test-prof//lib/test_prof/memory_prof/minitest.rb#8
  def current_example; end

  # source://test-prof//lib/test_prof/memory_prof/minitest.rb#21
  def prerecord(group, example); end
  ...
  # source://test-prof//lib/test_prof/memory_prof/minitest.rb#26
  def record(example); end

  # source://test-prof//lib/test_prof/memory_prof/minitest.rb#34
  def report; end

  # source://test-prof//lib/test_prof/memory_prof/minitest.rb#30
  def start; end
  ...
  # source://test-prof//lib/test_prof/memory_prof/minitest.rb#48
  def configure_profiler(options); end

  # source://test-prof//lib/test_prof/memory_prof/minitest.rb#41
...
#
# source://test-prof//lib/test_prof/core.rb#11
module Process
  ...
  class << self
    # source://test-prof//lib/test_prof/core.rb#19
...
module TestProf
  ...
  class << self
    ...
    #
    # source://test-prof//lib/test_prof/core.rb#100
    def activate(env_var, val = T.unsafe(nil)); end

    # Return a path to store artifact
    #
    # source://test-prof//lib/test_prof/core.rb#120
    def artifact_path(filename); end

    # Return absolute path to asset
    #
    # source://test-prof//lib/test_prof/core.rb#115
    def asset_path(filename); end

    # source://test-prof//lib/test_prof/core.rb#53
    def config; end

    # @yield [config]
    #
    # source://test-prof//lib/test_prof/core.rb#57
    def configure; end

    # source://test-prof//lib/test_prof/core.rb#133
    def create_artifact_dir; end

    # @return [Boolean]
    #
    # source://test-prof//lib/test_prof/core.rb#78
    def dry_run?; end
    ...
    # @return [Boolean]
    #
    # source://test-prof//lib/test_prof/core.rb#67
    def minitest?; end

    # Returns the current process time
    #
    # source://test-prof//lib/test_prof/core.rb#83
    def now; end

    # Require gem and shows a custom
    # message if it fails to load
    #
    # source://test-prof//lib/test_prof/core.rb#89
    ...
    # @return [Boolean]
    #
    # source://test-prof//lib/test_prof/core.rb#72
    def spring?; end

    private

    # source://test-prof//lib/test_prof/core.rb#139
    def activate!(env_var, val); end

    # source://test-prof//lib/test_prof/core.rb#161
    def notify_spring_activate(env_var); end

    # source://test-prof//lib/test_prof/core.rb#155
    def notify_spring_detected; end

    # source://test-prof//lib/test_prof/core.rb#149
    def with_report_suffix(path); end

    # source://test-prof//lib/test_prof/core.rb#143
...
#
# source://test-prof//lib/test_prof/core.rb#167
class TestProf::Configuration
  # @return [Configuration] a new instance of Configuration
  #
  # source://test-prof//lib/test_prof/core.rb#174
  def initialize; end

  # IO to write logs
  #
  # source://test-prof//lib/test_prof/core.rb#168
  def color; end
  ...
  # @return [Boolean]
  #
  # source://test-prof//lib/test_prof/core.rb#182
  def color?; end

  # source://test-prof//lib/test_prof/core.rb#190
  def logger; end
  ...
  # @return [Boolean]
  #
  # source://test-prof//lib/test_prof/core.rb#186
  def timestamps?; end
...
module TestProf::FactoryProf
  ...
  class << self
    # source://test-prof//lib/test_prof/factory_prof.rb#81
    def config; end
    ...
    # source://test-prof//lib/test_prof/factory_prof.rb#98
    def patch!; end

    # source://test-prof//lib/test_prof/factory_prof.rb#120
    def print(started_at); end

    # source://test-prof//lib/test_prof/factory_prof.rb#135
    def result; end

    # Inits FactoryProf and setups at exit hook,
    # then runs
    #
    # source://test-prof//lib/test_prof/factory_prof.rb#108
    def run; end
    ...
    # source://test-prof//lib/test_prof/factory_prof.rb#139
    def track(factory, variation:); end

    private

    # source://test-prof//lib/test_prof/factory_prof.rb#199
    def flush_stack; end

    # source://test-prof//lib/test_prof/factory_prof.rb#178
    ...
    # @return [Boolean]
    #
    # source://test-prof//lib/test_prof/factory_prof.rb#205
    def running?; end

    # source://test-prof//lib/test_prof/factory_prof.rb#188
    def track_count(factory); end

    # source://test-prof//lib/test_prof/factory_prof.rb#193
    def track_time(factory, t1, t2); end

    # source://test-prof//lib/test_prof/factory_prof.rb#159
...
class TestProf::FactoryProf::Configuration
  ...
  # Sets the attribute include_variations
  #
  # @param value the value to set the attribute include_variations to.
  #
  # source://test-prof//lib/test_prof/factory_prof.rb#19
  ...
  # @return [Boolean]
  #
  # source://test-prof//lib/test_prof/factory_prof.rb#44
  def include_variations?; end
  ...
  # Sets the attribute variations_limit
  #
  # @param value the value to set the attribute variations_limit to.
  #
  # source://test-prof//lib/test_prof/factory_prof.rb#19
...
module TestProf::FactoryProf::Printers::Simple
  ...
  class << self
    ...
    # source://test-prof//lib/test_prof/factory_prof/printers/simple.rb#54
    def format_args(stat); end
  end
end

# source://test-prof//lib/test_prof/factory_prof.rb#49
class TestProf::FactoryProf::Result
  # @return [Result] a new instance of Result
  #
  # source://test-prof//lib/test_prof/factory_prof.rb#52
  def initialize(stacks, raw_stats); end

  # Returns the value of attribute raw_stats.
  #
  # source://test-prof//lib/test_prof/factory_prof.rb#50
  def raw_stats; end
  ...
  #
  # source://test-prof//lib/test_prof/factory_prof.rb#58
  def stats; end

  # source://test-prof//lib/test_prof/factory_prof.rb#69
  def total_count; end
...
# source://test-prof//lib/test_prof/memory_prof/printer.rb#63
class TestProf::MemoryProf::AllocPrinter < ::TestProf::MemoryProf::Printer
  private

  # source://test-prof//lib/test_prof/memory_prof/printer.rb#74
  def memory_amount(item); end

  # source://test-prof//lib/test_prof/memory_prof/printer.rb#66
  def mode; end

  # source://test-prof//lib/test_prof/memory_prof/printer.rb#70
  def print_total; end
...
# source://test-prof//lib/test_prof/memory_prof/tracker.rb#62
class TestProf::MemoryProf::AllocTracker < ::TestProf::MemoryProf::Tracker
  # @return [Boolean]
  #
  # source://test-prof//lib/test_prof/memory_prof/tracker.rb#67
  def supported?; end
...
class TestProf::MemoryProf::Printer
  ...
  # source://test-prof//lib/test_prof/memory_prof/printer.rb#58
...
# source://test-prof//lib/test_prof/memory_prof/printer.rb#79
class TestProf::MemoryProf::RssPrinter < ::TestProf::MemoryProf::Printer
  private

  # source://test-prof//lib/test_prof/memory_prof/printer.rb#90
  def memory_amount(item); end

  # source://test-prof//lib/test_prof/memory_prof/printer.rb#82
  def mode; end

  # source://test-prof//lib/test_prof/memory_prof/printer.rb#86
  def print_total; end
...
# source://test-prof//lib/test_prof/memory_prof/tracker.rb#72
class TestProf::MemoryProf::RssTracker < ::TestProf::MemoryProf::Tracker
  # @return [RssTracker] a new instance of RssTracker
  #
  # source://test-prof//lib/test_prof/memory_prof/tracker.rb#73
  def initialize(top_count); end

  # @return [Boolean]
  #
  # source://test-prof//lib/test_prof/memory_prof/tracker.rb#83
  def supported?; end
...
class TestProf::MemoryProf::Tracker
  ...
  # source://test-prof//lib/test_prof/memory_prof/tracker.rb#54
  def group_finished(id); end

  # source://test-prof//lib/test_prof/memory_prof/tracker.rb#50
...
class TestProf::MemoryProf::Tracker::LinkedList
  ...
  # source://test-prof//lib/test_prof/memory_prof/tracker/linked_list.rb#67
...
class TestProf::MemoryProf::Tracker::LinkedListNode
  ...
  #
  # source://test-prof//lib/test_prof/memory_prof/tracker/linked_list.rb#81
  def initialize(id:, item:, memory_at_start:, previous:); end

  # source://test-prof//lib/test_prof/memory_prof/tracker/linked_list.rb#107
  def finish(memory_at_finish); end

  # source://test-prof//lib/test_prof/memory_prof/tracker/linked_list.rb#103
  def hooks_memory; end

  # Returns the value of attribute id.
  #
  # source://test-prof//lib/test_prof/memory_prof/tracker/linked_list.rb#79
  def id; end
  ...
  # source://test-prof//lib/test_prof/memory_prof/tracker/linked_list.rb#91
  def total_memory; end

  protected

  # source://test-prof//lib/test_prof/memory_prof/tracker/linked_list.rb#115
...
module TestProf::RubyProf
  ...
  class << self
    # source://test-prof//lib/test_prof/ruby_prof.rb#161
    def config; end

    # @yield [config]
    #
    # source://test-prof//lib/test_prof/ruby_prof.rb#165
    def configure; end

    # source://test-prof//lib/test_prof/ruby_prof.rb#183
    ...
    #
    # source://test-prof//lib/test_prof/ruby_prof.rb#173
    def run; end

    private

    # source://test-prof//lib/test_prof/ruby_prof.rb#241
    def check_ruby_prof_version; end

    # source://test-prof//lib/test_prof/ruby_prof.rb#260
    def exclude_common_methods(profiler); end

    # source://test-prof//lib/test_prof/ruby_prof.rb#252
    def exclude_rspec_methods(profiler); end

    # source://test-prof//lib/test_prof/ruby_prof.rb#229
    def init_ruby_prof; end

    # @return [Boolean]
    #
    # source://test-prof//lib/test_prof/ruby_prof.rb#225
    def locked?; end
  end
end
...
class TestProf::RubyProf::Configuration
  ...
  # @return [Boolean]
  #
  # source://test-prof//lib/test_prof/ruby_prof.rb#73
  def exclude_common_methods?; end
  ...
  # @return [Boolean]
  #
  # source://test-prof//lib/test_prof/ruby_prof.rb#65
  def include_threads?; end
  ...
  # @raise [ArgumentError]
  #
  # source://test-prof//lib/test_prof/ruby_prof.rb#82
  ...
  #
  # source://test-prof//lib/test_prof/ruby_prof.rb#94
  ...
  # Sets the attribute skip_boot
  #
  # @param value the value to set the attribute skip_boot to.
  #
  # source://test-prof//lib/test_prof/ruby_prof.rb#48
  ...
  # @return [Boolean]
  #
  # source://test-prof//lib/test_prof/ruby_prof.rb#69
  def skip_boot?; end
...
#
# source://test-prof//lib/test_prof/ruby_prof.rb#111
class TestProf::RubyProf::Report
  include ::TestProf::Logging

  # @return [Report] a new instance of Report
  #
  # source://test-prof//lib/test_prof/ruby_prof.rb#114
  def initialize(profiler); end

  # Stop profiling and generate the report
  # using provided name.
  #
  # source://test-prof//lib/test_prof/ruby_prof.rb#120
  def dump(name); end

  private

  # source://test-prof//lib/test_prof/ruby_prof.rb#146
  def build_path(name, printer); end

  # source://test-prof//lib/test_prof/ruby_prof.rb#153
  def config; end
...
#   TPS_PROF=10 rspec ...
#
# source://test-prof//lib/test_prof/tps_prof/profiler.rb#6
module TestProf::TPSProf
  class << self
    # source://test-prof//lib/test_prof/tps_prof.rb#33
    def config; end

    # @yield [config]
    #
    # source://test-prof//lib/test_prof/tps_prof.rb#37
    def configure; end
  end
end

# source://test-prof//lib/test_prof/tps_prof.rb#14
class TestProf::TPSProf::Configuration
  # @return [Configuration] a new instance of Configuration
  #
  # source://test-prof//lib/test_prof/tps_prof.rb#17
  def initialize; end

  # Returns the value of attribute reporter.
  #
  # source://test-prof//lib/test_prof/tps_prof.rb#15
  def reporter; end
  ...
  # source://test-prof//lib/test_prof/tps_prof.rb#26
...
# source://test-prof//lib/test_prof/tps_prof/profiler.rb#7
class TestProf::TPSProf::Profiler
  # @return [Profiler] a new instance of Profiler
  #
  # source://test-prof//lib/test_prof/tps_prof/profiler.rb#10
  def initialize(top_count, threshold: T.unsafe(nil)); end

  # source://test-prof//lib/test_prof/tps_prof/profiler.rb#45
  def example_finished(id); end

  # source://test-prof//lib/test_prof/tps_prof/profiler.rb#41
  def example_started(id); end

  # source://test-prof//lib/test_prof/tps_prof/profiler.rb#25
  def group_finished(id); end

  # source://test-prof//lib/test_prof/tps_prof/profiler.rb#18
  def group_started(id); end

  # Returns the value of attribute groups.
  #
  # source://test-prof//lib/test_prof/tps_prof/profiler.rb#8
  def groups; end
...
# source://test-prof//lib/test_prof/tps_prof/reporter/text.rb#8
module TestProf::TPSProf::Reporter; end

# source://test-prof//lib/test_prof/tps_prof/reporter/text.rb#9
class TestProf::TPSProf::Reporter::Text
  include ::TestProf::Logging

  # source://test-prof//lib/test_prof/tps_prof/reporter/text.rb#14
...
module TestProf::Vernier
  ...
  class << self
    # source://test-prof//lib/test_prof/vernier.rb#45
    def config; end

    # @yield [config]
    #
    # source://test-prof//lib/test_prof/vernier.rb#49
    def configure; end

    # Returns the value of attribute default_collector.
    #
    # source://test-prof//lib/test_prof/vernier.rb#53
    def default_collector; end

    # source://test-prof//lib/test_prof/vernier.rb#100
    def dump(collector, name); end

    # source://test-prof//lib/test_prof/vernier.rb#70
    def profile(name = T.unsafe(nil)); end

    # Run Vernier and automatically dump
    # a report when the process exits or when the application is booted.
    #
    # source://test-prof//lib/test_prof/vernier.rb#57
    def run; end

    private

    # source://test-prof//lib/test_prof/vernier.rb#112
    def build_path(name); end

    # source://test-prof//lib/test_prof/vernier.rb#135
    def check_vernier_version; end

    # source://test-prof//lib/test_prof/vernier.rb#122
    def init_vernier; end

    # @return [Boolean]
    #
    # source://test-prof//lib/test_prof/vernier.rb#118
    def locked?; end
  end
end
...
class TestProf::Vernier::Configuration
  ...
  # @return [Boolean]
  #
  # source://test-prof//lib/test_prof/vernier.rb#33
  def boot?; end
  ...
  # @return [Boolean]
  #
  # source://test-prof//lib/test_prof/vernier.rb#37
  def suite?; end
