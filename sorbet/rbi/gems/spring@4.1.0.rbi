...
module Spring
  class << self
    ...
    # source://spring//lib/spring/configuration.rb#27
    ...
    # source://spring//lib/spring/configuration.rb#39
    ...
    # source://spring//lib/spring/configuration.rb#18
    def gemfile_lock; end

    # source://spring//lib/spring/configuration.rb#52
    def project_root_path; end

    # source://spring//lib/spring/configuration.rb#56
    def quiet; end
    ...
    # source://spring//lib/spring/configuration.rb#62
...
class Spring::Watcher::Abstract
  ...
  #
  # source://spring//lib/spring/watcher/abstract.rb#16
  def initialize(root, latency); end

  # source://spring//lib/spring/watcher/abstract.rb#37
  def add(*items); end

  # source://spring//lib/spring/watcher/abstract.rb#33
  def debug; end

  # Returns the value of attribute directories.
  #
  # source://spring//lib/spring/watcher/abstract.rb#14
  def directories; end
  ...
  # source://spring//lib/spring/watcher/abstract.rb#90
  def mark_stale; end

  # source://spring//lib/spring/watcher/abstract.rb#29
  def on_debug(&block); end

  # source://spring//lib/spring/watcher/abstract.rb#85
  def on_stale(&block); end

  # source://spring//lib/spring/watcher/abstract.rb#97
  def restart; end
  ...
  # @return [Boolean]
  #
  # source://spring//lib/spring/watcher/abstract.rb#81
  def stale?; end

  # @raise [NotImplementedError]
  #
  # source://spring//lib/spring/watcher/abstract.rb#103
  def start; end

  # @raise [NotImplementedError]
  #
  # source://spring//lib/spring/watcher/abstract.rb#107
  def stop; end

  # @raise [NotImplementedError]
  #
  # source://spring//lib/spring/watcher/abstract.rb#111
