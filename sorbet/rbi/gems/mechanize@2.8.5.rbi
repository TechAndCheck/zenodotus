...
class HTTP::Cookie
  ...
  # source://http-cookie/1.0.8/lib/http/cookie.rb#133
  def initialize(*args); end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#648
  def <=>(other); end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#574
  def acceptable?; end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#555
  def acceptable_from_uri?(uri); end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#551
  def accessed_at; end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#551
  def accessed_at=(_arg0); end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#601
  def cookie_value; end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#548
  def created_at; end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#548
  def created_at=(_arg0); end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#386
  def domain; end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#389
  def domain=(domain); end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#434
  def domain_name; end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#429
  def dot_domain; end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#664
  def encode_with(coder); end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#541
  def expire!; end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#531
  def expired?(time = T.unsafe(nil)); end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#488
  def expires; end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#493
  def expires=(t); end
  ...
  # source://http-cookie/1.0.8/lib/http/cookie.rb#441
  def for_domain; end
  ...
  # source://http-cookie/1.0.8/lib/http/cookie.rb#479
  def httponly; end
  ...
  # source://http-cookie/1.0.8/lib/http/cookie.rb#671
  def init_with(coder); end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#640
  def inspect; end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#509
  def max_age; end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#512
  def max_age=(sec); end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#350
  def name; end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#353
  def name=(name); end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#453
  def origin; end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#456
  def origin=(origin); end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#444
  def path; end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#447
  def path=(path); end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#473
  def secure; end
  ...
  # source://http-cookie/1.0.8/lib/http/cookie.rb#485
  def session; end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#485
  def session?; end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#610
  def set_cookie_value; end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#601
  def to_s; end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#659
  def to_yaml_properties; end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#589
  def valid_for_uri?(uri); end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#367
  def value; end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#370
  def value=(value); end

  # source://http-cookie/1.0.8/lib/http/cookie.rb#676
  def yaml_initialize(tag, map); end

  class << self
    # source://http-cookie/1.0.8/lib/http/cookie.rb#334
    def cookie_value(cookies); end

    # source://http-cookie/1.0.8/lib/http/cookie.rb#341
    ...
    # source://http-cookie/1.0.8/lib/http/cookie.rb#232
...
class HTTP::CookieJar
  ...
  # source://http-cookie/1.0.8/lib/http/cookie_jar.rb#69
  def initialize(options = T.unsafe(nil)); end

  # source://http-cookie/1.0.8/lib/http/cookie_jar.rb#105
  def <<(cookie); end

  # source://mechanize//lib/mechanize/cookie_jar.rb#12
  def add(arg1, arg2 = T.unsafe(nil)); end

  # source://http-cookie/1.0.8/lib/http/cookie_jar.rb#340
  def cleanup(session = T.unsafe(nil)); end

  # source://http-cookie/1.0.8/lib/http/cookie_jar.rb#333
  def clear; end

  # source://http-cookie/1.0.8/lib/http/cookie_jar.rb#130
  def cookies(url = T.unsafe(nil)); end

  # source://http-cookie/1.0.8/lib/http/cookie_jar.rb#122
  def delete(cookie); end

  # source://http-cookie/1.0.8/lib/http/cookie_jar.rb#155
  def each(uri = T.unsafe(nil), &block); end

  # source://http-cookie/1.0.8/lib/http/cookie_jar.rb#136
  def empty?(url = T.unsafe(nil)); end

  # source://http-cookie/1.0.8/lib/http/cookie_jar.rb#294
  def load(readable, *options); end

  # source://http-cookie/1.0.8/lib/http/cookie_jar.rb#183
  def parse(set_cookie, origin, options = T.unsafe(nil)); end

  # source://http-cookie/1.0.8/lib/http/cookie_jar.rb#231
  def save(writable, *options); end

  # source://http-cookie/1.0.8/lib/http/cookie_jar.rb#30
  def store; end

  private

  # source://http-cookie/1.0.8/lib/http/cookie_jar.rb#32
  def get_impl(base, value, *args); end

  # source://http-cookie/1.0.8/lib/http/cookie_jar.rb#78
  ...
  class << self
    ...
    # source://http-cookie/1.0.8/lib/http/cookie_jar.rb#10
...
class Mechanize
  ...
  #
  # source://mechanize//lib/mechanize.rb#724
  def add_auth(uri, user, password, realm = T.unsafe(nil), domain = T.unsafe(nil)); end

  # :section: Utilities
  #
  # source://mechanize//lib/mechanize.rb#1235
  def agent; end
  ...
  #
  # source://mechanize//lib/mechanize.rb#1091
  def ca_file=(ca_file); end

  # An OpenSSL client certificate or the path to a certificate file.
  #
  # source://mechanize//lib/mechanize.rb#1098
  def cert; end

  # Sets the OpenSSL client certificate +cert+ to the given path or
  # certificate instance
  #
  # source://mechanize//lib/mechanize.rb#1106
  def cert=(cert); end
  ...
  #
  # source://mechanize//lib/mechanize.rb#1132
  def cert_store; end
  ...
  # See also #cert_store
  #
  # source://mechanize//lib/mechanize.rb#1141
  ...
  #
  # source://mechanize//lib/mechanize.rb#333
  def click(link); end

  # Are If-Modified-Since conditional requests enabled?
  #
  # source://mechanize//lib/mechanize.rb#731
  def conditional_requests; end

  # Disables If-Modified-Since conditional requests (enabled by default)
  #
  # source://mechanize//lib/mechanize.rb#738
  ...
  #
  # source://mechanize//lib/mechanize.rb#639
  ...
  #
  # source://mechanize//lib/mechanize.rb#392
  ...
  # values
  #
  # source://mechanize//lib/mechanize.rb#954
  ...
  #
  # source://mechanize//lib/mechanize.rb#944
  ...
  #
  # source://mechanize//lib/mechanize.rb#814
  ...
  # value may help.
  #
  # source://mechanize//lib/mechanize.rb#822
  ...
  #
  # source://mechanize//lib/mechanize.rb#876
  def log=(logger); end
  ...
  #
  # source://mechanize//lib/mechanize.rb#886
  ...
  #
  # source://mechanize//lib/mechanize.rb#903
  ...
  #
  # source://mechanize//lib/mechanize.rb#910
  def open_timeout; end

  # Sets the connection open timeout to +open_timeout+
  #
  # source://mechanize//lib/mechanize.rb#917
  ...
  #
  # source://mechanize//lib/mechanize.rb#1172
  def pass; end

  # Sets the client key password to +pass+
  #
  # source://mechanize//lib/mechanize.rb#1179
  def pass=(pass); end
  ...
  #
  # source://mechanize//lib/mechanize.rb#511
  ...
  #
  # source://mechanize//lib/mechanize.rb#312
  ...
  # source://mechanize//lib/mechanize.rb#1268
  def pretty_print(q); end

  # The HTTP proxy address
  #
  # source://mechanize//lib/mechanize.rb#674
  def proxy_addr; end

  # The HTTP proxy password
  #
  # source://mechanize//lib/mechanize.rb#679
  def proxy_pass; end

  # The HTTP proxy port
  #
  # source://mechanize//lib/mechanize.rb#684
  def proxy_port; end

  # The HTTP proxy username
  #
  # source://mechanize//lib/mechanize.rb#689
  def proxy_user; end
  ...
  #
  # source://mechanize//lib/mechanize.rb#932
  ...
  #
  # source://mechanize//lib/mechanize.rb#1300
  def shutdown; end

  # SSL version to use.
  #
  # source://mechanize//lib/mechanize.rb#1186
  def ssl_version; end

  # Sets the SSL version to use to +version+ without client/server
  # negotiation.
  #
  # source://mechanize//lib/mechanize.rb#1194
  ...
  #
  # source://mechanize//lib/mechanize.rb#1065
  ...
  #
  # source://mechanize//lib/mechanize.rb#1206
  ...
  #
  # source://mechanize//lib/mechanize.rb#1222
  def verify_mode; end

  # Sets the OpenSSL server certificate verification method.
  #
  # source://mechanize//lib/mechanize.rb#1229
  ...
  # @return [Boolean]
  #
  # source://mechanize//lib/mechanize.rb#278
  def visited?(url); end
  ...
  #
  # source://mechanize//lib/mechanize.rb#1332
  ...
  class << self
    ...
    #
    # source://mechanize//lib/mechanize.rb#624
    def html_parser; end
    ...
    # source://mechanize//lib/mechanize.rb#150
    ...
    #
    # source://mechanize//lib/mechanize.rb#631
    def log; end
    ...
    #   end
    #
    # source://mechanize//lib/mechanize.rb#166
    def start; end
  end
end
...
class Mechanize::Page < ::Mechanize::File
  ...
  #
  # source://mechanize//lib/mechanize/page.rb#530
  def bases; end
  ...
  # with href="canonical".
  #
  # source://mechanize//lib/mechanize/page.rb#182
  def canonical_uri; end

  # Get the content type
  #
  # source://mechanize//lib/mechanize/page.rb#193
  def content_type; end
  ...
  # source://mechanize//lib/mechanize/page.rb#95
  def encoding; end

  # source://mechanize//lib/mechanize/page.rb#79
  ...
  # @return [Boolean]
  #
  # source://mechanize//lib/mechanize/page.rb#103
  ...
  #
  # source://mechanize//lib/mechanize/page.rb#509
  def forms; end
  ...
  #
  # source://mechanize//lib/mechanize/page.rb#537
  def frames; end
  ...
  #
  # source://mechanize//lib/mechanize/page.rb#544
  def iframes; end
  ...
  # source://mechanize//lib/mechanize/page.rb#556
  def image_urls; end
  ...
  #
  # source://mechanize//lib/mechanize/page.rb#551
  def images; end
  ...
  #
  # source://mechanize//lib/mechanize/page.rb#562
  def labels; end

  # source://mechanize//lib/mechanize/page.rb#567
  def labels_hash; end
  ...
  #
  # source://mechanize//lib/mechanize/page.rb#499
  def links; end
  ...
  #
  # source://mechanize//lib/mechanize/page.rb#520
  ...
  # See also Nokogiri::XML::Node#at_xpath for details.
  #
  # source://mechanize//lib/mechanize/page.rb#113
  def parser; end

  # source://mechanize//lib/mechanize/page.rb#136
  def pretty_print(q); end

  # source://mechanize//lib/mechanize/page.rb#167
  def reset; end
  ...
  # source://mechanize//lib/mechanize/page.rb#59
  def title; end
  ...
  # source://mechanize//lib/mechanize/page.rb#633
  def html_body; end

  class << self
    # source://mechanize//lib/mechanize/page.rb#579
    ...
    #
    # source://mechanize//lib/mechanize/page.rb#601
    def meta_charset(body); end

    # Retrieves the last <tt>content-type</tt> set by a +meta+ tag in +body+
    #
    # source://mechanize//lib/mechanize/page.rb#619
    def meta_content_type(body); end

    # source://mechanize//lib/mechanize/page.rb#588
