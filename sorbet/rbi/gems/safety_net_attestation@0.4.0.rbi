...
class SafetyNetAttestation::CertificateSubjectError < ::SafetyNetAttestation::Error
  class << self
...
class SafetyNetAttestation::Error < ::StandardError
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class SafetyNetAttestation::NonceMismatchError < ::SafetyNetAttestation::Error
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class SafetyNetAttestation::NotVerifiedError < ::SafetyNetAttestation::Error
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class SafetyNetAttestation::SignatureError < ::SafetyNetAttestation::Error
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class SafetyNetAttestation::TimestampError < ::SafetyNetAttestation::Error
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
