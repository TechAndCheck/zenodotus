...
# source://redis//lib/redis/connection/hiredis.rb#11
class Redis::Connection::Hiredis
  # @return [Hiredis] a new instance of Hiredis
  #
  # source://redis//lib/redis/connection/hiredis.rb#31
  def initialize(connection); end

  # @return [Boolean]
  #
  # source://redis//lib/redis/connection/hiredis.rb#35
  def connected?; end

  # source://redis//lib/redis/connection/hiredis.rb#44
  def disconnect; end

  # source://redis//lib/redis/connection/hiredis.rb#55
  def read; end

  # source://redis//lib/redis/connection/hiredis.rb#39
  def timeout=(timeout); end

  # source://redis//lib/redis/connection/hiredis.rb#49
  def write(command); end

  class << self
    # source://redis//lib/redis/connection/hiredis.rb#12
