...
class IO::Event::Selector::Select
  ...
  # source://io-event//lib/io/event/selector/select.rb#373
  ...
  #
  # source://io-event//lib/io/event/selector/select.rb#291
  def io_read(fiber, _io, buffer, length, offset = T.unsafe(nil)); end
  ...
  #
  # source://io-event//lib/io/event/selector/select.rb#334
  def io_write(fiber, _io, buffer, length, offset = T.unsafe(nil)); end
  ...
  # source://io-event//lib/io/event/selector/select.rb#379
  ...
  # source://io-event//lib/io/event/selector/select.rb#398
  def select(duration = T.unsafe(nil)); end
...
module IO::Event::Support
  class << self
    ...
    # @return [Boolean]
    #
    # source://io-event//lib/io/event/support.rb#14
    ...
    # @return [Boolean]
    #
    # source://io-event//lib/io/event/support.rb#19
    ...
    # @return [Boolean]
    #
    # source://io-event//lib/io/event/support.rb#30
