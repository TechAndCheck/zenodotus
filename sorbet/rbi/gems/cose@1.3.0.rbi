...
class COSE::Error < ::StandardError
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class COSE::KeyDeserializationError < ::COSE::Error
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class COSE::MalformedKeyError < ::COSE::KeyDeserializationError
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class COSE::UnknownKeyType < ::COSE::KeyDeserializationError
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
