...
class Honeybadger::Agent
  ...
  # @return self
  #
  # source://honeybadger//lib/honeybadger/agent.rb#324
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/agent.rb#298
  def breadcrumbs; end
  ...
  #   otherwise.
  #
  # source://honeybadger//lib/honeybadger/agent.rb#205
  def check_in(id); end

  # Clear all transaction scoped data.
  #
  # source://honeybadger//lib/honeybadger/agent.rb#280
  def clear!; end
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/agent.rb#457
  def config; end
  ...
  #
  # source://honeybadger//lib/honeybadger/agent.rb#272
  ...
  # @return [void]
  #
  # source://honeybadger//lib/honeybadger/agent.rb#409
  def event(event_type, payload = T.unsafe(nil)); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/agent.rb#530
  ...
  #   data is flushed).
  #
  # source://honeybadger//lib/honeybadger/agent.rb#365
  def flush; end
  ...
  # source://honeybadger//lib/honeybadger/agent.rb#567
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/agent.rb#449
  def registry; end
  ...
  #
  # source://honeybadger//lib/honeybadger/agent.rb#378
  ...
  #
  # source://honeybadger//lib/honeybadger/agent.rb#389
  ...
  #   otherwise.
  #
  # source://honeybadger//lib/honeybadger/agent.rb#224
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/agent.rb#520
  ...
  # source://honeybadger//lib/honeybadger/agent.rb#581
  def context_manager; end

  # source://honeybadger//lib/honeybadger/agent.rb#601
  def init_events_worker; end

  # source://honeybadger//lib/honeybadger/agent.rb#606
  def init_metrics_worker; end

  # source://honeybadger//lib/honeybadger/agent.rb#596
  def init_worker; end

  # source://honeybadger//lib/honeybadger/agent.rb#586
  def push(object); end

  # source://honeybadger//lib/honeybadger/agent.rb#591
  def send_now(object); end

  # @raise [ArgumentError]
  #
  # source://honeybadger//lib/honeybadger/agent.rb#573
  def validate_notify_opts!(opts); end

  # source://honeybadger//lib/honeybadger/agent.rb#611
...
class Honeybadger::Config
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#336
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#352
  ...
  def load_plugin_insights_events?(name); end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/config.rb#319
  def load_plugin_insights_metrics?(name); end
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#326
  def root_regexp; end
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#418
  def build_file_logger(path); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#429
  def build_logger; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#409
  def build_stdout_logger; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#376
  def config_path; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#380
  def config_paths; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#386
  def default_backend; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#365
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#488
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#391
  def init_backend!; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#444
  def init_logging!; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#464
  def load_config_from_disk; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#455
  def locate_absolute_path(path, root); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#370
  def log_path; end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/config.rb#425
  def log_stdout?; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#472
...
# source://honeybadger//lib/honeybadger/config/defaults.rb#522
...
# source://honeybadger//lib/honeybadger/config/defaults.rb#46
...
# source://honeybadger//lib/honeybadger/event.rb#6
class Honeybadger::Event
  ...
  #
  # source://honeybadger//lib/honeybadger/event.rb#21
  ...
  #
  # source://honeybadger//lib/honeybadger/event.rb#51
  ...
  #
  # source://honeybadger//lib/honeybadger/event.rb#13
  def event_type; end
  ...
  # Returns nothing.
  #
  # source://honeybadger//lib/honeybadger/event.rb#37
  def halt!; end
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/event.rb#43
  def halted?; end

  # The payload data of the event
  #
  # source://honeybadger//lib/honeybadger/event.rb#16
  def payload; end

  # The timestamp of the event
  #
  # source://honeybadger//lib/honeybadger/event.rb#10
  def ts; end
...
class Honeybadger::EventsWorker::Thread < ::Thread
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class Honeybadger::Histogram < ::Honeybadger::Metric
  # source://honeybadger//lib/honeybadger/histogram.rb#31
  def bins; end

  # source://honeybadger//lib/honeybadger/histogram.rb#25
  def find_bin(value); end

  # source://honeybadger//lib/honeybadger/histogram.rb#35
  def payloads; end
...
#   end
#
# source://honeybadger//lib/honeybadger/instrumentation.rb#27
class Honeybadger::Instrumentation
  # @return [Instrumentation] a new instance of Instrumentation
  #
  # source://honeybadger//lib/honeybadger/instrumentation.rb#30
  ...
  # source://honeybadger//lib/honeybadger/instrumentation.rb#109
  def decrement_counter(name, *args); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/instrumentation.rb#150
  def extract_attributes(args); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/instrumentation.rb#155
  def extract_callable(args); end

  # source://honeybadger//lib/honeybadger/instrumentation.rb#127
  def gauge(name, *args); end

  # source://honeybadger//lib/honeybadger/instrumentation.rb#69
  def histogram(name, *args); end

  # source://honeybadger//lib/honeybadger/instrumentation.rb#91
  ...
  #
  # source://honeybadger//lib/honeybadger/instrumentation.rb#40
  def monotonic_timer; end

  # source://honeybadger//lib/honeybadger/instrumentation.rb#34
  def registry; end

  # source://honeybadger//lib/honeybadger/instrumentation.rb#47
...
#   end
#
# source://honeybadger//lib/honeybadger/instrumentation_helper.rb#27
module Honeybadger::InstrumentationHelper
  # source://honeybadger//lib/honeybadger/instrumentation_helper.rb#88
  def decrement_counter(name, *args); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/instrumentation_helper.rb#113
  def extract_attributes(args); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/instrumentation_helper.rb#119
  def extract_callable(args); end

  # source://honeybadger//lib/honeybadger/instrumentation_helper.rb#100
  def gauge(name, *args); end

  # source://honeybadger//lib/honeybadger/instrumentation_helper.rb#64
  def histogram(name, *args); end

  # source://honeybadger//lib/honeybadger/instrumentation_helper.rb#76
  def increment_counter(name, *args); end

  # source://honeybadger//lib/honeybadger/instrumentation_helper.rb#39
  def metric_agent(agent); end

  # source://honeybadger//lib/honeybadger/instrumentation_helper.rb#47
  def metric_attributes(attributes); end

  # source://honeybadger//lib/honeybadger/instrumentation_helper.rb#43
  def metric_instrumentation; end

  # source://honeybadger//lib/honeybadger/instrumentation_helper.rb#35
  def metric_source(source); end

  # returns two parameters, the first is the duration of the execution, and the second is
  # the return value of the passed block
  #
  # source://honeybadger//lib/honeybadger/instrumentation_helper.rb#31
  def monotonic_timer; end

  # source://honeybadger//lib/honeybadger/instrumentation_helper.rb#52
  def time(name, *args); end
end
...
class Honeybadger::MetricsWorker::Thread < ::Thread
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class Honeybadger::Notice
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#190
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#240
  def as_json(*args); end
  ...
  # Returns nothing.
  #
  # source://honeybadger//lib/honeybadger/notice.rb#291
  def halt!; end
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/notice.rb#297
  def halted?; end
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#154
  def parsed_backtrace; end

  # The ID of the request which caused this notice.
  #
  # source://honeybadger//lib/honeybadger/notice.rb#148
  def request_id; end
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#278
  def to_json(*a); end
  ...
  # Returns the value of attribute config.
  #
  # source://honeybadger//lib/honeybadger/notice.rb#303
  def config; end

  # source://honeybadger//lib/honeybadger/notice.rb#368
  def construct_backtrace_filters(opts); end

  # source://honeybadger//lib/honeybadger/notice.rb#418
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#381
  def construct_request_hash; end

  # source://honeybadger//lib/honeybadger/notice.rb#442
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#327
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#535
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#398
  def exception_context(exception); end

  # source://honeybadger//lib/honeybadger/notice.rb#426
  def fingerprint_from_opts(opts); end

  # source://honeybadger//lib/honeybadger/notice.rb#437
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#339
  def from_exception(attribute); end

  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/notice.rb#312
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/notice.rb#355
  def ignore_by_class?(ignored_class = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/notice.rb#306
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#463
  ...
  # source://honeybadger//lib/honeybadger/notice.rb#578
  def params_filters; end
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#510
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#568
  ...
  # source://honeybadger//lib/honeybadger/notice.rb#582
  ...
  # source://honeybadger//lib/honeybadger/notice.rb#454
  def s(data); end

  # Sanitize metadata to keep it at a single level and remove any filtered
  # parameters
  #
  # source://honeybadger//lib/honeybadger/notice.rb#409
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/notice.rb#501
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#551
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#525
...
# @api private
#
# source://honeybadger//lib/honeybadger/notice.rb#168
...
# @api private
#
# source://honeybadger//lib/honeybadger/notice.rb#164
...
# @api private
#
# source://honeybadger//lib/honeybadger/notice.rb#160
...
class Honeybadger::Timer < ::Honeybadger::Gauge
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
