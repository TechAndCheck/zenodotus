...
# source://bindata//lib/bindata/delayed_io.rb#178
module BinData::Base::AutoCallDelayedIO
  # source://bindata//lib/bindata/delayed_io.rb#179
  def initialize_shared_instance; end

  # source://bindata//lib/bindata/delayed_io.rb#192
  def num_bytes; end

  # source://bindata//lib/bindata/delayed_io.rb#184
  def read(io); end

  # source://bindata//lib/bindata/delayed_io.rb#188
  def write(io, *_); end
end
