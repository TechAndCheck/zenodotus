...
# source://webauthn//lib/webauthn/public_key_credential/options.rb#6
module WebAuthn
  class << self
    # source://webauthn//lib/webauthn/configuration.rb#7
    def configuration; end

    # @yield [configuration]
    #
    # source://webauthn//lib/webauthn/configuration.rb#11
    def configure; end
...
class WebAuthn::AttestationObject
  ...
  #
  # source://webauthn//lib/webauthn/attestation_object.rb#30
  ...
  #
  # source://webauthn//lib/webauthn/attestation_object.rb#28
  ...
  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/attestation_object.rb#40
  def valid_attestation_statement?(client_data_hash); end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/attestation_object.rb#35
...
class WebAuthn::AttestationStatement::Base
  ...
  # source://webauthn//lib/webauthn/attestation_statement/base.rb#44
  def attestation_certificate; end

  # source://webauthn//lib/webauthn/attestation_statement/base.rb#48
  def attestation_certificate_key_id; end

  # source://webauthn//lib/webauthn/attestation_statement/base.rb#40
  def format; end

  # @raise [NotImplementedError]
  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/attestation_statement/base.rb#36
  def valid?(_authenticator_data, _client_data_hash); end

  private

  # source://webauthn//lib/webauthn/attestation_statement/base.rb#77
  def algorithm; end

  # source://webauthn//lib/webauthn/attestation_statement/base.rb#111
  def attestation_root_certificates_store(aaguid: T.unsafe(nil), attestation_certificate_key_id: T.unsafe(nil)); end

  # source://webauthn//lib/webauthn/attestation_statement/base.rb#89
  def attestation_trust_path; end

  # source://webauthn//lib/webauthn/attestation_statement/base.rb#70
  def certificates; end

  # source://webauthn//lib/webauthn/attestation_statement/base.rb#159
  def cose_algorithm; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/attestation_statement/base.rb#56
  def matching_aaguid?(attested_credential_data_aaguid); end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/attestation_statement/base.rb#66
  def matching_public_key?(authenticator_data); end

  # source://webauthn//lib/webauthn/attestation_statement/base.rb#81
  def raw_certificates; end

  # Returns the value of attribute relying_party.
  #
  # source://webauthn//lib/webauthn/attestation_statement/base.rb#54
  def relying_party; end

  # source://webauthn//lib/webauthn/attestation_statement/base.rb#122
  def root_certificates(aaguid: T.unsafe(nil), attestation_certificate_key_id: T.unsafe(nil)); end

  # source://webauthn//lib/webauthn/attestation_statement/base.rb#85
  def signature; end
...
class WebAuthn::AttestationStatement::FormatNotSupportedError < ::WebAuthn::Error
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::AttestationStatement::UnsupportedAlgorithm < ::WebAuthn::Error
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::AttestationStatementVerificationError < ::WebAuthn::VerificationError
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::AttestationTrustworthinessVerificationError < ::WebAuthn::VerificationError
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::AttestedCredentialDataFormatError < ::WebAuthn::Error
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::AttestedCredentialVerificationError < ::WebAuthn::VerificationError
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::AuthenticatorAssertionResponse < ::WebAuthn::AuthenticatorResponse
  ...
  #
  # source://webauthn//lib/webauthn/authenticator_assertion_response.rb#32
  def initialize(authenticator_data:, signature:, user_handle: T.unsafe(nil), **options); end

  # source://webauthn//lib/webauthn/authenticator_assertion_response.rb#48
  def authenticator_data; end

  # Returns the value of attribute user_handle.
  #
  # source://webauthn//lib/webauthn/authenticator_assertion_response.rb#30
  def user_handle; end

  # source://webauthn//lib/webauthn/authenticator_assertion_response.rb#40
  ...
  #
  # source://webauthn//lib/webauthn/authenticator_assertion_response.rb#54
  ...
  # source://webauthn//lib/webauthn/authenticator_assertion_response.rb#69
  def type; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_assertion_response.rb#60
  def valid_sign_count?(stored_sign_count); end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_assertion_response.rb#56
...
class WebAuthn::AuthenticatorAttestationResponse < ::WebAuthn::AuthenticatorResponse
  ...
  #
  # source://webauthn//lib/webauthn/authenticator_attestation_response.rb#33
  ...
  # source://webauthn//lib/webauthn/authenticator_attestation_response.rb#51
  ...
  #
  # source://webauthn//lib/webauthn/authenticator_attestation_response.rb#31
  def attestation_trust_path; end
  ...
  # source://webauthn//lib/webauthn/authenticator_attestation_response.rb#40
  ...
  # source://webauthn//lib/webauthn/authenticator_attestation_response.rb#70
  def type; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_attestation_response.rb#79
  def valid_attestation_statement?; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_attestation_response.rb#74
  def valid_attested_credential?; end
...
class WebAuthn::AuthenticatorData::AttestedCredentialData < ::BinData::Record
  # source://webauthn//lib/webauthn/authenticator_data/attested_credential_data.rb#42
  def aaguid; end

  # source://webauthn//lib/webauthn/authenticator_data/attested_credential_data.rb#46
  def credential; end

  # source://webauthn//lib/webauthn/authenticator_data/attested_credential_data.rb#53
  def length; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_data/attested_credential_data.rb#38
  def valid?; end

  private

  # source://webauthn//lib/webauthn/authenticator_data/attested_credential_data.rb#61
  def algorithm; end

  # source://webauthn//lib/webauthn/authenticator_data/attested_credential_data.rb#69
  def cose_key; end

  # source://webauthn//lib/webauthn/authenticator_data/attested_credential_data.rb#73
  def public_key; end

  # source://webauthn//lib/webauthn/authenticator_data/attested_credential_data.rb#77
  def public_key_length; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_data/attested_credential_data.rb#65
  def valid_credential_public_key?; end

  class << self
    # source://webauthn//lib/webauthn/authenticator_data/attested_credential_data.rb#32
    def deserialize(data); end
  end
end
...
# source://webauthn//lib/webauthn/authenticator_data/attested_credential_data.rb#26
...
class WebAuthn::AuthenticatorDataFormatError < ::WebAuthn::Error
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::AuthenticatorDataVerificationError < ::WebAuthn::VerificationError
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::AuthenticatorResponse
  ...
  # source://webauthn//lib/webauthn/authenticator_response.rb#55
  def client_data; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#49
  def valid?(*args, **keyword_arguments); end

  # source://webauthn//lib/webauthn/authenticator_response.rb#27
  def verify(expected_challenge, expected_origin = T.unsafe(nil), user_verification: T.unsafe(nil), rp_id: T.unsafe(nil)); end
  ...
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#61
  ...
  # source://webauthn//lib/webauthn/authenticator_response.rb#107
  def rp_id_from_origin(expected_origin); end

  # @raise [NotImplementedError]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#111
  def type; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#93
  def valid_authenticator_data?; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#81
  def valid_challenge?(expected_challenge); end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#85
  def valid_origin?(expected_origin); end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#89
  def valid_rp_id?(rp_id); end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#77
  def valid_token_binding?; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#73
  def valid_type?; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#99
  def valid_user_presence?; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/authenticator_response.rb#103
  def valid_user_verified?; end

  # source://webauthn//lib/webauthn/authenticator_response.rb#63
...
class WebAuthn::ChallengeVerificationError < ::WebAuthn::VerificationError
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::ClientDataMissingError < ::WebAuthn::Error
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
# source://webauthn//lib/webauthn/configuration.rb#15
class WebAuthn::Configuration
  extend ::Forwardable

  # @return [Configuration] a new instance of Configuration
  #
  # source://webauthn//lib/webauthn/configuration.rb#40
  def initialize; end
  ...
  # Returns the value of attribute relying_party.
  #
  # source://webauthn//lib/webauthn/configuration.rb#38
  def relying_party; end

  # source://webauthn//lib/webauthn/configuration.rb#52
  def rp_id; end

  # source://webauthn//lib/webauthn/configuration.rb#56
  def rp_id=(id); end
...
module WebAuthn::Credential
  class << self
    # source://webauthn//lib/webauthn/credential.rb#19
    def from_create(credential, relying_party: T.unsafe(nil)); end

    # source://webauthn//lib/webauthn/credential.rb#23
    def from_get(credential, relying_party: T.unsafe(nil)); end

    # source://webauthn//lib/webauthn/credential.rb#11
    def options_for_create(**keyword_arguments); end

    # source://webauthn//lib/webauthn/credential.rb#15
...
class WebAuthn::CredentialRPEntity < ::WebAuthn::CredentialEntity
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::Error < ::StandardError
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::OriginVerificationError < ::WebAuthn::VerificationError
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::PublicKey::UnsupportedAlgorithm < ::WebAuthn::Error
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::PublicKeyCredential
  ...
  #
  # source://webauthn//lib/webauthn/public_key_credential.rb#20
  def initialize(type:, id:, raw_id:, response:, client_extension_outputs: T.unsafe(nil), encoder: T.unsafe(nil)); end

  # source://webauthn//lib/webauthn/public_key_credential.rb#47
  ...
  # source://webauthn//lib/webauthn/public_key_credential.rb#43
  def sign_count; end
  ...
  # source://webauthn//lib/webauthn/public_key_credential.rb#36
  def verify(*_args); end

  private

  # source://webauthn//lib/webauthn/public_key_credential.rb#63
  def authenticator_data; end

  # Returns the value of attribute encoder.
  #
  # source://webauthn//lib/webauthn/public_key_credential.rb#53
  def encoder; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/public_key_credential.rb#59
  def valid_id?; end

  # @return [Boolean]
  #
  # source://webauthn//lib/webauthn/public_key_credential.rb#55
  def valid_type?; end
...
class WebAuthn::PublicKeyCredential::Options
  ...
  #
  # source://webauthn//lib/webauthn/public_key_credential/options.rb#24
  def as_json(*_arg0); end

  # source://webauthn//lib/webauthn/public_key_credential/options.rb#19
  def challenge; end
  ...
  # source://webauthn//lib/webauthn/public_key_credential/options.rb#64
  def as_public_key_descriptors(ids); end

  # source://webauthn//lib/webauthn/public_key_credential/options.rb#48
  def attributes; end

  # source://webauthn//lib/webauthn/public_key_credential/options.rb#60
  def default_timeout; end

  # source://webauthn//lib/webauthn/public_key_credential/options.rb#52
  def encoder; end

  # source://webauthn//lib/webauthn/public_key_credential/options.rb#56
  def raw_challenge; end

  # source://webauthn//lib/webauthn/public_key_credential/options.rb#30
  def to_hash; end
...
# source://webauthn//lib/webauthn/relying_party.rb#11
class WebAuthn::RelyingParty
  # @return [RelyingParty] a new instance of RelyingParty
  #
  # source://webauthn//lib/webauthn/relying_party.rb#18
  def initialize(algorithms: T.unsafe(nil), encoding: T.unsafe(nil), origin: T.unsafe(nil), id: T.unsafe(nil), name: T.unsafe(nil), verify_attestation_statement: T.unsafe(nil), credential_options_timeout: T.unsafe(nil), silent_authentication: T.unsafe(nil), acceptable_attestation_types: T.unsafe(nil), attestation_root_certificates_finders: T.unsafe(nil)); end

  # Returns the value of attribute acceptable_attestation_types.
  #
  # source://webauthn//lib/webauthn/relying_party.rb#42
  ...
  #
  # source://webauthn//lib/webauthn/relying_party.rb#52
  def attestation_root_certificates_finders; end

  # source://webauthn//lib/webauthn/relying_party.rb#60
  ...
  #
  # source://webauthn//lib/webauthn/relying_party.rb#56
  def encoder; end
  ...
  # source://webauthn//lib/webauthn/relying_party.rb#89
  def options_for_authentication(**keyword_arguments); end

  # source://webauthn//lib/webauthn/relying_party.rb#74
  ...
  # source://webauthn//lib/webauthn/relying_party.rb#96
  def verify_authentication(raw_credential, challenge, user_verification: T.unsafe(nil), public_key: T.unsafe(nil), sign_count: T.unsafe(nil)); end

  # source://webauthn//lib/webauthn/relying_party.rb#81
  def verify_registration(raw_credential, challenge, user_verification: T.unsafe(nil)); end

  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end

    # source://webauthn//lib/webauthn/relying_party.rb#12
    def if_pss_supported(algorithm); end
  end
end

# source://webauthn//lib/webauthn/relying_party.rb#16
WebAuthn::RelyingParty::DEFAULT_ALGORITHMS = T.let(T.unsafe(nil), Array)

# source://webauthn//lib/webauthn/relying_party.rb#9
class WebAuthn::RootCertificateFinderNotSupportedError < ::WebAuthn::Error
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::RpIdVerificationError < ::WebAuthn::VerificationError
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::SignCountVerificationError < ::WebAuthn::VerificationError
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::SignatureVerificationError < ::WebAuthn::VerificationError
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::TokenBindingVerificationError < ::WebAuthn::VerificationError
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::TypeVerificationError < ::WebAuthn::VerificationError
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::UserPresenceVerificationError < ::WebAuthn::VerificationError
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::UserVerifiedVerificationError < ::WebAuthn::VerificationError
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebAuthn::VerificationError < ::WebAuthn::Error
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
