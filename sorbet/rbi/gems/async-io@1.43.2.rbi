...
# source://async-io//lib/async/io/generic.rb#11
module Async; end

# source://async-io//lib/async/io/generic.rb#12
module Async::IO
  class << self
    # @return [Boolean]
    #
    # source://async-io//lib/async/io.rb#22
    def buffer?; end

    # source://async-io//lib/async/io.rb#18
    def file_descriptor_limit; end

    # source://async-io//lib/async/io/generic.rb#28
    def pipe; end

    # Convert a Ruby ::IO object to a wrapped instance:
    #
    # source://async-io//lib/async/io/generic.rb#20
...
#
# source://async-io//lib/async/io/generic.rb#14
...
class Async::IO::BasicSocket < ::Async::IO::Generic
  ...
  #
  # source://async-io//lib/async/io/generic.rb#46
  def recv(*args); end

  # source://async-io//lib/async/io/generic.rb#53
...
# source://async-io//lib/async/io/composite_endpoint.rb#10
class Async::IO::CompositeEndpoint < ::Async::IO::Endpoint
  # @return [CompositeEndpoint] a new instance of CompositeEndpoint
  #
  # source://async-io//lib/async/io/composite_endpoint.rb#11
  def initialize(endpoints, **options); end

  # source://async-io//lib/async/io/composite_endpoint.rb#33
  def bind(&block); end

  # source://async-io//lib/async/io/composite_endpoint.rb#20
  def connect(&block); end

  # source://async-io//lib/async/io/composite_endpoint.rb#16
  def each(&block); end
end
...
class Async::IO::Endpoint
  ...
  # source://async-io//lib/async/io/shared_endpoint.rb#117
  def bound(**options); end

  # source://async-io//lib/async/io/shared_endpoint.rb#121
  ...
  class << self
    # source://async-io//lib/async/io/composite_endpoint.rb#39
    def composite(*endpoints, **options); end

    # Generate a list of endpoints from an array.
    #
    # source://async-io//lib/async/io/endpoint/each.rb#31
    ...
    #
    # source://async-io//lib/async/io/endpoint.rb#90
    def parse(string, **options); end

    # source://async-io//lib/async/io/socket_endpoint.rb#51
    ...
    # @return [SSLEndpoint]
    #
    # source://async-io//lib/async/io/ssl_endpoint.rb#100
    ...
    # source://async-io//lib/async/io/endpoint/each.rb#14
...
#
# source://async-io//lib/async/io/generic.rb#33
class Async::IO::Generic < ::Async::Wrapper
  extend ::Forwardable

  # source://async-io//lib/async/io/generic.rb#155
  def <<(buffer); end
  ...
  # @return [Boolean]
  #
  # source://async-io//lib/async/io/generic.rb#191
  def connected?; end

  # source://async-io//lib/async/io/generic.rb#160
  def dup; end
  ...
  # source://async-io//lib/async/io/generic.rb#179
  def nonblock; end

  # source://async-io//lib/async/io/generic.rb#183
  def nonblock=(value); end

  # @return [Boolean]
  #
  # source://async-io//lib/async/io/generic.rb#187
  def nonblock?; end
  ...
  #
  # source://async-io//lib/async/io/generic.rb#96
  ...
  # @return [Boolean]
  #
  # source://async-io//lib/async/io/generic.rb#195
  def readable?; end
  ...
  #
  # source://async-io//lib/async/io/generic.rb#199
  def timeout; end
  ...
  # source://async-io//lib/async/io/generic.rb#166
  def wait(timeout = T.unsafe(nil), mode = T.unsafe(nil)); end

  # source://async-io//lib/async/io/generic.rb#139
  ...
  # source://async-io//lib/async/io/generic.rb#203
  ...
  class << self
    ...
    #
    # source://async-io//lib/async/io/generic.rb#73
    def wrap(*args); end

    # source://async-io//lib/async/io/generic.rb#42
    def wrap_blocking_method(new_name, method_name, invert: T.unsafe(nil), &block); end

    # Returns the value of attribute wrapped_klass.
    #
    # source://async-io//lib/async/io/generic.rb#59
...
# source://async-io//lib/async/io/generic.rb#36
...
#
# source://async-io//lib/async/io/generic.rb#17
...
class Async::IO::SSLEndpoint < ::Async::IO::Endpoint
  ...
  # @yield [Socket] the socket which is being connected
  #
  # source://async-io//lib/async/io/ssl_endpoint.rb#77
  def connect(&block); end

  # source://async-io//lib/async/io/ssl_endpoint.rb#55
  def context; end

  # source://async-io//lib/async/io/ssl_endpoint.rb#81
  def each; end
...
class Async::IO::SSLServer
  ...
  # source://async-io//lib/async/io/ssl_socket.rb#121
  def accept(task: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # source://async-io//lib/async/io/ssl_socket.rb#104
  def fileno; end

  # source://forwardable/1.3.3/forwardable.rb#231
  def getsockopt(*args, **_arg1, &block); end

  # source://async-io//lib/async/io/ssl_socket.rb#117
  def listen(*args); end
...
class Async::IO::SSLSocket < ::Async::IO::Generic
  ...
  # source://async-io//lib/async/io/ssl_socket.rb#85
  def close_read; end

  # source://async-io//lib/async/io/ssl_socket.rb#80
  def close_write; end
  ...
  # source://async-io//lib/async/io/ssl_socket.rb#72
  def local_address; end
  ...
  # source://async-io//lib/async/io/ssl_socket.rb#76
  ...
  # source://async-io//lib/async/io/ssl_socket.rb#89
...
#
# source://async-io//lib/async/io/shared_endpoint.rb#13
class Async::IO::SharedEndpoint < ::Async::IO::Endpoint
  # @return [SharedEndpoint] a new instance of SharedEndpoint
  #
  # source://async-io//lib/async/io/shared_endpoint.rb#43
  def initialize(endpoint, wrappers, **options); end

  # source://async-io//lib/async/io/shared_endpoint.rb#105
  def accept(backlog = T.unsafe(nil), **options, &block); end

  # source://async-io//lib/async/io/shared_endpoint.rb#76
  def bind; end

  # Close all the internal wrappers.
  #
  # source://async-io//lib/async/io/shared_endpoint.rb#71
  def close; end

  # source://async-io//lib/async/io/shared_endpoint.rb#87
  def connect; end

  # Returns the value of attribute endpoint.
  #
  # source://async-io//lib/async/io/shared_endpoint.rb#50
  def endpoint; end

  # source://async-io//lib/async/io/shared_endpoint.rb#53
  def local_address_endpoint(**options); end

  # source://async-io//lib/async/io/shared_endpoint.rb#62
  def remote_address_endpoint(**options); end

  # source://async-io//lib/async/io/shared_endpoint.rb#111
  def to_s; end

  # Returns the value of attribute wrappers.
  #
  # source://async-io//lib/async/io/shared_endpoint.rb#51
  def wrappers; end

  class << self
    # Create a new `SharedEndpoint` by binding to the given endpoint.
    #
    # source://async-io//lib/async/io/shared_endpoint.rb#15
    def bound(endpoint, backlog: T.unsafe(nil), close_on_exec: T.unsafe(nil), **options); end

    # Create a new `SharedEndpoint` by connecting to the given endpoint.
    #
    # source://async-io//lib/async/io/shared_endpoint.rb#34
...
#
# source://async-io//lib/async/io/socket_endpoint.rb#11
class Async::IO::SocketEndpoint < ::Async::IO::Endpoint
  # @return [SocketEndpoint] a new instance of SocketEndpoint
  #
  # source://async-io//lib/async/io/socket_endpoint.rb#12
  def initialize(socket, **options); end

  # source://async-io//lib/async/io/socket_endpoint.rb#25
  def bind(&block); end

  # source://async-io//lib/async/io/socket_endpoint.rb#37
  def connect(&block); end

  # Returns the value of attribute socket.
  #
  # source://async-io//lib/async/io/socket_endpoint.rb#23
  def socket; end

  # source://async-io//lib/async/io/socket_endpoint.rb#19
  def to_s; end
end
...
class Async::IO::Stream
  ...
  #
  # source://async-io//lib/async/io/stream.rb#182
  def <<(string); end

  # Returns the value of attribute block_size.
  #
  # source://async-io//lib/async/io/stream.rb#57
  def block_size; end

  # Best effort to flush any unwritten data, and then close the underling IO.
  #
  # source://async-io//lib/async/io/stream.rb#219
  def close; end

  # source://async-io//lib/async/io/stream.rb#208
  def close_read; end

  # source://async-io//lib/async/io/stream.rb#212
  def close_write; end

  # @return [Boolean]
  #
  # source://async-io//lib/async/io/stream.rb#204
  def closed?; end
  ...
  # @return [Boolean]
  #
  # source://async-io//lib/async/io/stream.rb#232
  def eof; end

  # @raise [EOFError]
  #
  # source://async-io//lib/async/io/stream.rb#244
  def eof!; end
  ...
  #
  # source://async-io//lib/async/io/stream.rb#151
  def flush; end

  # source://async-io//lib/async/io/stream.rb#146
  def gets(separator = T.unsafe(nil), **options); end

  # Returns the value of attribute io.
  #
  # source://async-io//lib/async/io/stream.rb#55
  def io; end

  # source://async-io//lib/async/io/stream.rb#129
  ...
  #
  # source://async-io//lib/async/io/stream.rb#60
  def read(size = T.unsafe(nil)); end

  # @raise [exception]
  #
  # source://async-io//lib/async/io/stream.rb#91
  def read_exactly(size, exception: T.unsafe(nil)); end

  # Read at most `size` bytes from the stream. Will avoid reading from the underlying stream if possible.
  #
  # source://async-io//lib/async/io/stream.rb#81
  ...
  #
  # source://async-io//lib/async/io/stream.rb#110
  def read_until(pattern, offset = T.unsafe(nil), chomp: T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://async-io//lib/async/io/stream.rb#200
  def readable?; end

  # source://async-io//lib/async/io/stream.rb#103
  ...
  #
  # source://async-io//lib/async/io/stream.rb#171
  ...
  #
  # source://async-io//lib/async/io/stream.rb#299
  def consume_read_buffer(size = T.unsafe(nil)); end

  # Fills the buffer from the underlying stream.
  #
  # source://async-io//lib/async/io/stream.rb#269
  ...
  class << self
    # source://async-io//lib/async/io/stream.rb#19
    def open(path, mode = T.unsafe(nil), **options); end
  end
end

# source://async-io//lib/async/io/stream.rb#17
Async::IO::Stream::BLOCK_SIZE = T.let(T.unsafe(nil), Integer)

# source://async-io//lib/async/io/version.rb#8
