...
module Flipper
  ...
  class << self
    # @return [Boolean]
    #
    # source://flipper-active_record/1.2.2/lib/flipper/version.rb#10
...
class Flipper::Adapters::Strict
  ...
  #
  # source://flipper//lib/flipper/adapters/strict.rb#17
  ...
  # source://forwardable/1.3.3/forwardable.rb#231
  def get_all(*args, **_arg1, &block); end

  # source://flipper//lib/flipper/adapters/strict.rb#28
  def get_multi(features); end
  ...
  # source://flipper//lib/flipper/adapters/strict.rb#35
...
# source://flipper//lib/flipper/adapters/strict.rb#9
class Flipper::Adapters::Strict::NotFound < ::Flipper::Error
  # @return [NotFound] a new instance of NotFound
  #
  # source://flipper//lib/flipper/adapters/strict.rb#10
...
class Flipper::Exporters::Json::InvalidError < ::StandardError
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class Flipper::Exporters::Json::JsonError < ::Flipper::Exporters::Json::InvalidError
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
module Flipper::Serializers::Gzip
  private

  # source://flipper//lib/flipper/serializers/gzip.rb#18
  def deserialize(source); end

  # source://flipper//lib/flipper/serializers/gzip.rb#9
...
module Flipper::Serializers::Json
  private

  # source://flipper//lib/flipper/serializers/json.rb#13
  def deserialize(source); end

  # source://flipper//lib/flipper/serializers/json.rb#8
  def serialize(source); end
