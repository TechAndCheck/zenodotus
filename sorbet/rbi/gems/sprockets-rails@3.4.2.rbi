...
module Rails
  class << self
    # source://railties/7.2.2.1/lib/rails.rb#44
    def app_class; end

    # source://railties/7.2.2.1/lib/rails.rb#44
    def app_class=(_arg0); end

    # source://railties/7.2.2.1/lib/rails.rb#45
    def application; end

    # source://railties/7.2.2.1/lib/rails.rb#43
    def application=(_arg0); end

    # source://railties/7.2.2.1/lib/rails.rb#126
    def autoloaders; end

    # source://railties/7.2.2.1/lib/rails.rb#56
    ...
    # source://railties/7.2.2.1/lib/rails.rb#52
    def configuration; end

    # source://railties/7.2.2.1/lib/rails/deprecator.rb#4
    def deprecator; end

    # source://railties/7.2.2.1/lib/rails.rb#75
    def env; end

    # source://railties/7.2.2.1/lib/rails.rb#82
    def env=(environment); end

    # source://railties/7.2.2.1/lib/rails.rb#93
    def error; end

    # source://railties/7.2.2.1/lib/rails/gem_version.rb#5
    def gem_version; end

    # source://railties/7.2.2.1/lib/rails.rb#106
    def groups(*groups); end

    # source://railties/7.2.2.1/lib/rails.rb#49
    ...
    # source://railties/7.2.2.1/lib/rails.rb#122
    def public_path; end

    # source://railties/7.2.2.1/lib/rails.rb#65
    def root; end

    # source://railties/7.2.2.1/lib/rails/version.rb#7
    def version; end
  end
end
...
class Rails::Application < ::Rails::Engine
  # source://railties/7.2.2.1/lib/rails/application.rb#108
  ...
  # source://railties/7.2.2.1/lib/rails/application.rb#101
  def autoloaders; end

  # source://railties/7.2.2.1/lib/rails/engine.rb#516
  def build_middleware_stack; end

  # source://railties/7.2.2.1/lib/rails/application.rb#446
  def config; end

  # source://railties/7.2.2.1/lib/rails/application.rb#450
  def config=(_arg0); end

  # source://railties/7.2.2.1/lib/rails/application.rb#283
  def config_for(name, env: T.unsafe(nil)); end

  # source://railties/7.2.2.1/lib/rails/application.rb#366
  def console(&blk); end

  # source://railties/7.2.2.1/lib/rails/application.rb#487
  def credentials; end

  # source://railties/7.2.2.1/lib/rails/application.rb#451
  def credentials=(_arg0); end

  # source://railties/7.2.2.1/lib/rails/application.rb#103
  def default_url_options(*_arg0, **_arg1, &_arg2); end

  # source://railties/7.2.2.1/lib/rails/application.rb#103
  def default_url_options=(arg); end

  # source://railties/7.2.2.1/lib/rails/application.rb#239
  def deprecators; end

  # source://railties/7.2.2.1/lib/rails/application.rb#545
  def eager_load!; end

  # source://railties/7.2.2.1/lib/rails/application.rb#506
  def encrypted(path, key_path: T.unsafe(nil), env_key: T.unsafe(nil)); end

  # source://railties/7.2.2.1/lib/rails/application.rb#312
  def env_config; end

  # source://railties/7.2.2.1/lib/rails/application.rb#101
  def executor; end

  # source://railties/7.2.2.1/lib/rails/application.rb#372
  def generators(&blk); end

  # source://railties/7.2.2.1/lib/rails/application.rb#519
  ...
  # source://railties/7.2.2.1/lib/rails/application.rb#433
  def initialize!(group = T.unsafe(nil)); end

  # source://railties/7.2.2.1/lib/rails/application.rb#133
  def initialized?; end

  # source://railties/7.2.2.1/lib/rails/application.rb#354
  def initializer(name, opts = T.unsafe(nil), &block); end

  # source://railties/7.2.2.1/lib/rails/application.rb#440
  def initializers; end

  # source://railties/7.2.2.1/lib/rails/application.rb#383
  def isolate_namespace(mod); end

  # source://railties/7.2.2.1/lib/rails/application.rb#167
  def key_generator(secret_key_base = T.unsafe(nil)); end

  # source://railties/7.2.2.1/lib/rails/application.rb#539
  def load_generators(app = T.unsafe(nil)); end

  # source://railties/7.2.2.1/lib/rails/application.rb#231
  def message_verifier(verifier_name); end

  # source://railties/7.2.2.1/lib/rails/application.rb#203
  def message_verifiers; end

  # source://railties/7.2.2.1/lib/rails/application.rb#535
  def migration_railties; end

  # source://railties/7.2.2.1/lib/rails/application.rb#140
  def name; end
  ...
  # source://railties/7.2.2.1/lib/rails/application.rb#347
  def rake_tasks(&block); end

  # source://railties/7.2.2.1/lib/rails/application.rb#159
  ...
  # source://railties/7.2.2.1/lib/rails/application.rb#409
  def require_environment!; end

  # source://railties/7.2.2.1/lib/rails/application.rb#414
  def routes_reloader; end

  # source://railties/7.2.2.1/lib/rails/application.rb#144
  def run_load_hooks!; end

  # source://railties/7.2.2.1/lib/rails/application.rb#360
  def runner(&blk); end

  # source://railties/7.2.2.1/lib/rails/application.rb#99
  def sandbox; end
  ...
  # source://railties/7.2.2.1/lib/rails/application.rb#469
  def secret_key_base; end

  # source://railties/7.2.2.1/lib/rails/application.rb#378
  def server(&blk); end

  # source://railties/7.2.2.1/lib/rails/application.rb#515
  def to_app; end

  # source://railties/7.2.2.1/lib/rails/application.rb#421
  def watchable_args; end

  protected

  # source://railties/7.2.2.1/lib/rails/application.rb#618
  def default_middleware_stack; end

  # source://railties/7.2.2.1/lib/rails/application.rb#623
  def ensure_generator_templates_added; end

  # source://railties/7.2.2.1/lib/rails/application.rb#584
  def ordered_railties; end

  # source://railties/7.2.2.1/lib/rails/application.rb#606
  def railties_initializers(current); end

  # source://railties/7.2.2.1/lib/rails/application.rb#573
  def run_console_blocks(app); end

  # source://railties/7.2.2.1/lib/rails/application.rb#563
  def run_generators_blocks(app); end

  # source://railties/7.2.2.1/lib/rails/application.rb#568
  def run_runner_blocks(app); end

  # source://railties/7.2.2.1/lib/rails/application.rb#578
  def run_server_blocks(app); end

  # source://railties/7.2.2.1/lib/rails/application.rb#552
  def run_tasks_blocks(app); end

  private

  # source://railties/7.2.2.1/lib/rails/application.rb#636
  def build_middleware; end

  # source://railties/7.2.2.1/lib/rails/application.rb#629
  def build_request(env); end

  # source://railties/7.2.2.1/lib/rails/application.rb#640
  def coerce_same_site_protection(protection); end

  # source://railties/7.2.2.1/lib/rails/application.rb#644
  def filter_parameters; end

  class << self
    # source://railties/7.2.2.1/lib/rails/application.rb#402
    def add_lib_to_load_path!(root); end

    # source://railties/7.2.2.1/lib/rails/application.rb#83
    def create(initial_variable_values = T.unsafe(nil), &block); end

    # source://railties/7.2.2.1/lib/rails/application.rb#87
    def find_root(from); end

    # source://railties/7.2.2.1/lib/rails/application.rb#70
    def inherited(base); end

    # source://railties/7.2.2.1/lib/rails/application.rb#79
    def instance; end
...
class Rails::Application::Configuration < ::Rails::Engine::Configuration
  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#30
  def initialize(*_arg0); end

  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#14
  ...
  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#558
  def annotations; end

  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#28
  def api_only; end

  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#373
  ...
  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#468
  def autoload_lib(ignore:); end

  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#480
  ...
  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#385
  ...
  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#492
  def colorize_logging; end

  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#496
  ...
  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#563
  ...
  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#431
  def database_configuration; end

  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#387
  def debug_exception_response_format; end

  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#391
  def debug_exception_response_format=(_arg0); end

  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#580
  ...
  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#349
  def enable_reloading; end

  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#353
  def enable_reloading=(value); end

  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#28
  def encoding; end

  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#365
  ...
  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#592
  def inspect; end

  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#413
  def load_database_yaml; end

  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#91
  ...
  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#380
  ...
  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#393
  def paths; end

  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#572
  ...
  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#357
  def read_encrypted_secrets; end

  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#361
  ...
  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#345
  ...
  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#501
  def secret_key_base; end

  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#511
  ...
  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#538
  def session_store(new_session_store = T.unsafe(nil), **options); end

  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#554
  ...
  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#619
  def credentials_defaults; end

  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#629
  def generate_local_secret; end

  # source://railties/7.2.2.1/lib/rails/application/configuration.rb#641
  def generate_local_secret?; end
end

# source://sprockets-rails//lib/sprockets/railtie.rb#57
class Rails::Engine < ::Rails::Railtie
  # source://railties/7.2.2.1/lib/rails/engine.rb#439
  def initialize; end
  ...
  # source://railties/7.2.2.1/lib/rails/engine.rb#533
  def call(env); end

  # source://railties/7.2.2.1/lib/rails/engine.rb#552
  def config; end

  # source://railties/7.2.2.1/lib/rails/engine.rb#490
  def eager_load!; end

  # source://railties/7.2.2.1/lib/rails/engine.rb#528
  def endpoint; end

  # source://railties/7.2.2.1/lib/rails/engine.rb#437
  def engine_name(*_arg0, **_arg1, &_arg2); end

  # source://railties/7.2.2.1/lib/rails/engine.rb#539
  def env_config; end

  # source://railties/7.2.2.1/lib/rails/engine.rb#500
  def helpers; end

  # source://railties/7.2.2.1/lib/rails/engine.rb#511
  def helpers_paths; end

  # source://railties/7.2.2.1/lib/rails/engine.rb#437
  def isolated?(&_arg0); end

  # source://railties/7.2.2.1/lib/rails/engine.rb#453
  def load_console(app = T.unsafe(nil)); end

  # source://railties/7.2.2.1/lib/rails/engine.rb#476
  def load_generators(app = T.unsafe(nil)); end

  # source://railties/7.2.2.1/lib/rails/engine.rb#461
  def load_runner(app = T.unsafe(nil)); end

  # source://railties/7.2.2.1/lib/rails/engine.rb#560
  def load_seed; end

  # source://railties/7.2.2.1/lib/rails/engine.rb#485
  def load_server(app = T.unsafe(nil)); end

  # source://railties/7.2.2.1/lib/rails/engine.rb#468
  def load_tasks(app = T.unsafe(nil)); end

  # source://railties/7.2.2.1/lib/rails/engine.rb#436
  def middleware(*_arg0, **_arg1, &_arg2); end

  # source://railties/7.2.2.1/lib/rails/engine.rb#436
  def paths(*_arg0, **_arg1, &_arg2); end

  # source://railties/7.2.2.1/lib/rails/engine.rb#495
  def railties; end

  # source://railties/7.2.2.1/lib/rails/engine.rb#436
  def root(*_arg0, **_arg1, &_arg2); end

  # source://railties/7.2.2.1/lib/rails/engine.rb#545
  def routes(&block); end

  # source://railties/7.2.2.1/lib/rails/engine.rb#676
  def routes?; end

  protected

  # source://railties/7.2.2.1/lib/rails/engine.rb#681
  def run_tasks_blocks(*_arg0); end

  private

  # source://railties/7.2.2.1/lib/rails/engine.rb#713
  def _all_autoload_once_paths; end

  # source://railties/7.2.2.1/lib/rails/engine.rb#717
  def _all_autoload_paths; end

  # source://railties/7.2.2.1/lib/rails/engine.rb#726
  def _all_load_paths(add_autoload_paths_to_load_path); end

  # source://railties/7.2.2.1/lib/rails/engine.rb#751
  def build_middleware; end

  # source://railties/7.2.2.1/lib/rails/engine.rb#743
  def build_request(env); end

  # source://railties/7.2.2.1/lib/rails/engine.rb#709
  def default_middleware_stack; end

  # source://railties/7.2.2.1/lib/rails/engine.rb#737
  def fixtures_in_root_and_not_in_vendor_or_dot_dir?(fixtures); end

  # source://railties/7.2.2.1/lib/rails/engine.rb#693
  def has_migrations?; end

  # source://railties/7.2.2.1/lib/rails/engine.rb#687
  ...
  class << self
    ...
    # source://railties/7.2.2.1/lib/rails/engine.rb#354
    def called_from; end

    # source://railties/7.2.2.1/lib/rails/engine.rb#354
    def called_from=(_arg0); end

    # source://railties/7.2.2.1/lib/rails/engine.rb#359
    def eager_load!(*_arg0, **_arg1, &_arg2); end

    # source://railties/7.2.2.1/lib/rails/engine.rb#379
    def endpoint(endpoint = T.unsafe(nil)); end

    # source://railties/7.2.2.1/lib/rails/railtie.rb#176
    def engine_name(name = T.unsafe(nil)); end

    # source://railties/7.2.2.1/lib/rails/engine.rb#423
    def find(path); end

    # source://railties/7.2.2.1/lib/rails/engine.rb#375
    def find_root(from); end

    # source://railties/7.2.2.1/lib/rails/engine.rb#697
    def find_root_with_flag(flag, root_path, default = T.unsafe(nil)); end

    # source://railties/7.2.2.1/lib/rails/engine.rb#361
    def inherited(base); end

    # source://railties/7.2.2.1/lib/rails/engine.rb#385
    def isolate_namespace(mod); end
