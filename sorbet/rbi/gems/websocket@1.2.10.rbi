...
class WebSocket::Error < ::RuntimeError
  class << self
...
class WebSocket::Error::Frame < ::WebSocket::Error
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebSocket::Error::Handshake < ::WebSocket::Error
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
...
class WebSocket::Handshake::Handler::Server < ::WebSocket::Handshake::Handler::Base
  class << self
    # source://comma/4.7.0/lib/comma/object.rb#7
    def comma_formats; end
  end
