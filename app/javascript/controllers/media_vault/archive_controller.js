...
export default class extends Controller {
  ...
  toggleCaption() {
    switch (this.captionCollapseModeValue) {
      case "collapsed":
        ...
        this.captionTogglerTarget.innerText =
          this.captionTogglerTarget.dataset.collapseLabel;
        break;
      case "expanded":
        this.captionCollapseModeValue = "collapsed";
        this.captionTogglerTarget.innerText =
          this.captionTogglerTarget.dataset.expandLabel;
        break;
      default:
  ...
  showFilters() {
    if (this.filterWrapperTarget.classList.contains("hidden")) {
      ...
      this.filterWrapperToggleTarget.innerHTML =
