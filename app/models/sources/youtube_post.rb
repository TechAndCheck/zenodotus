  ...
  def normalized_attrs_for_views
    {
      ...
      author_canonical_path:            self.author.nil? ? "" : url_helpers.youtube_channel_path(self.author),
      author_profile_image_url:         self.author.nil? ? "" : self.author.channel_image_url,
      author_display_name:              self.author.nil? ? "" : self.author.title,
      author_username:                  nil,
      author_community_count:           self.author.nil? ? "" : self.author.num_subscribers,
