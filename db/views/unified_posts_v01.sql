...
SELECT post_id, text, posts_with_media.author_id, posted_at, number_of_likes, image_data, video_data, display_name, handle, followers_count, following_count, profile, description, profile_image_url
